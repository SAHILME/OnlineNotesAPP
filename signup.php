...
$message .= "http://localhost/NotesAppFinal/activate.php/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'sahilmeshram676@gmail.com')){
