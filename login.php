...
if($count !== 1){
    ...
    if(empty($_POST['rememberme'])){
        ...
        echo "success";
        //extra adding  header("Location: http://localhost/NotesAppFinal/mainpageloggedin.php");on login.php
        header("Location: http://localhost/NotesAppFinal/mainpageloggedin.php");
    }else{
